...
(function(){
    ...
    (function() {
    var p = "3596270", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3596270||'',
    GUID:window.ftGUID_3596270||'99999999999',
    confID:window.ftConfID_3596270||'0',
    ftReturn: window.ftReturn_3596270||'',
    keyword:window.ftKeyword_3596270||'',
    ftId:window.ftId_3596270||'',
    imp:window.ftImp3596270,
    ftImpId:window.ftImp3596270 && window.ftImp3596270.impID || '',
    campaignID:'103584',
    cID:'89884',
    pID:'3596270',
    creativeID:'2504810',
    exttrack:["https://secure.insightexpressai.com/adServer/adServerESI.aspx?script=false&bannerID=4000155&siteID=653&creativeID=2504810&placementID=3596270&rnd=[%random%]&redir=https://secure.insightexpressai.com/adserver/1pixel.gif"],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/103584;3596270;2504810;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.holidayinnexpress.com"],
    placementDescription:'300x250DBMUSEXInvUSENNADeskStandardNAPMPKayakTier3',
    width:300,
    height:250,
    ...
    divID:'ftdiv3596270',
    phID:'ftpos3596270',
    frameID:'ftframe3596270',
    expID:'ftexpframe3596270',
    altImgID:'ftalt3596270',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/103584;3596270;2504810;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.holidayinnexpress.com',
    altImg:'http://servedby.flashtalking.com/imp/8/103584;3596270;204;gif;DBM;300x250DBMUSEXInvUSENNADeskStandardNAPMPKayakTier3/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/103584;3596270;271;pixel;DBM;300x250DBMUSEXInvUSENNADeskStandardNAPMPKayakTier3/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/359/3596270/2504810/js/j-3596270-2504810.js',
    file:'http://cdn.flashtalking.com/89884/2504810/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?130622727-3596270;2504810;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3596270||'',
    segmentList:window.ftSegmentList_3596270||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3596270 && window.ftImp3596270.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3596270')&&/^https:/.test(document.getElementById('ftscript_m3596270').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3596270'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3596270'],
        ['ftcfid', 'ftConfID_3596270'],
        ['fttime', 'ftTimestamp_3596270'],
        ['ftsection', 'ftSection_3596270'],
        ['ftcustom', 'ftCustom_3596270'],
        ['ft_id', 'ftId_3596270'],
        ['ftimpid','ftImp3596270', 'impID']
    ]
};
