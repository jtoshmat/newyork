    ...
    <div class="container">
        ...
        <nav class="nav-bar">
            <ul class="nav-list">
                ...
                <li class="hotel ic-arrow1"><a class="n2">Hotel</a></li>
...
<div class="search-container">
    ...
    <div class="search-box">
        <form action="search.php" class="flights-form">
        ...
        <form action="search.php" class="hotel-form hide">
            <div class="search-box1">
                <div class="mar areabox">
                    <span class="glyphicon glyphicon-map-marker icon"></span>
                    <input class="areabox" name="from_city" type="text" placeholder="Departure">
...
<script>
    ...
    $(document).ready(() => {
        $('.hotel').on('click', event => {
            $(event.currentTarget).addClass('ic-arrow1');
        });
    });
