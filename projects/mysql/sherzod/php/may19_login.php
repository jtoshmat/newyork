...
if (isset($_POST['is_form_submitted']) && $_POST['is_form_submitted'] == 1) {
    ...
    if ($email == 'shburkutboyev@gmail.com' && $password == 'mysql123') {
        $msg = "You are logged in successfully";
        header('Location: may19_account.php?msg=' . $msg);
    } else {
        $msg = "Your credential are incorrect. Please try again";
        header('Location: may19_login.php?msg=' . $msg);
        exit;
    }
}
?>
